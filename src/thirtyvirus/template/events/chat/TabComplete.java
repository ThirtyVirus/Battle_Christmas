...
public class TabComplete implements TabCompleter {
    ...
    public TabComplete(BattleChristmas main) { this.main = main; }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (command.getName().equals("bc")) {
            ...
            // no arguments
            if (args.length == 1){
                if (player.hasPermission("BattleChristmas.user")) { arguments.addAll(Arrays.asList("help", "info", "tutorial")); }
                if (player.hasPermission("BattleChristmas.admin")) { arguments.addAll(Arrays.asList("reload")); }
